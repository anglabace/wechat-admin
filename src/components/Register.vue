<template>
  <mu-container>
    <mu-form ref="form" :model="validateForm" class="mu-demo-form">
      ...
      <mu-form-item label help-text prop="remark">
        <mu-text-field v-model="validateForm.remark" prop="remark" placeholder="备注"></mu-text-field>
      </mu-form-item>
  ...
  methods: {
    submit() {
      ...
      this.$refs.form.validate().then(result => {
        ...
        let remark = this.validateForm.remark;
        let role = this.validateForm.role;
        console.log(username, password,remark,role);
        axios({
          method: "post",
          url: "/apis/api/manage/backend/registerUser",
          headers: {
